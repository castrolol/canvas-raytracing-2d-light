...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "ee910f8e5b0b728611ea";
...
"use strict";
eval("\n\nvar _boundary = __webpack_require__(/*! ./boundary */ \"./src/boundary.js\");\n\nvar _boundary2 = _interopRequireDefault(_boundary);\n\nvar _particle = __webpack_require__(/*! ./particle */ \"./src/particle.js\");\n\nvar _particle2 = _interopRequireDefault(_particle);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar objs = [];\nvar walls = [];\n\nvar particles = void 0;\n\nwindow.preload = function () {};\n\nwindow.setup = function () {\n  createCanvas(400, 400);\n\n  walls.push(new _boundary2.default(-1, -1, -1, 401));\n  walls.push(new _boundary2.default(-1, -1, 401, -1));\n  walls.push(new _boundary2.default(-1, 401, 401, 401));\n  walls.push(new _boundary2.default(401, -1, 401, 401));\n\n  for (var i = 0; i < 5; i++) {\n    var x1 = random(width);\n    var y1 = random(height);\n    var x2 = random(width);\n    var y2 = random(height);\n    var b = new _boundary2.default(x1, y1, x2, y2);\n    objs.push(b);\n    walls.push(b);\n  }\n  objs.push(particles = new _particle2.default(createVector(100, 200)));\n};\n\nwindow.draw = function () {\n  blendMode(BLEND);\n\n  background(0);\n  // particles.lookAt(mouseX, mouseY);\n  particles.pos.x = mouseX;\n  particles.pos.y = mouseY;\n  particles.look(walls);\n  objs.forEach(function (x) {\n    return x.show();\n  });\n\n  blendMode(MULTIPLY);\n  fill(255, 0, 0);\n\n  circle(30, 30, 20);\n\n  fill(255);\n  // var pt = particles.cast(objs[0]);\n  // if (pt) {\n  //   fill(255);\n  //   ellipse(pt.x, pt.y, 8, 8);\n  // }\n};\n\n//# sourceURL=webpack:///./src/index.js?");
